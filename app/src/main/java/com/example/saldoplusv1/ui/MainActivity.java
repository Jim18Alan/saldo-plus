...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_movs, R.id.nav_add, R.id.nav_scan, R.id.nav_apartado, R.id.nav_history, R.id.nav_settings)
        ...
        View headerView = navigationView.getHeaderView(0); // 0 = primer header
        TextView headerTitle = headerView.findViewById(R.id.header_title);

        RepositorioUsuario repo = new RepositorioUsuario(MainActivity.this);
        if (repo.isRegistered()){
            String nombre = repo.obtenerNombre();
            headerTitle.setText("Hola " + nombre + " 👋");
        }
